    ...
    <section className="lg:py-16">
      <div className="grid grid-cols-1 sm:grid-cols-12 xs:flex flex-col">
        ...
        >
          ...
          <p className="text-[#ADB7BE] text-base sm:text-lg mb-6 lg:text-xl sm:mr-4">
          ...
          <div>
            ...
            >
              <span className="block bg-[#121212] font-medium hover:bg-blue-500 rounded-full px-5 py-2 transition-all duration-300">
                Download CV
              </span>
            </Link>
          </div>
